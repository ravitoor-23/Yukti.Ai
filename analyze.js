...
{"opportunity":"<one punchy sentence naming the automation opportunity>","before":"<short phrase: how it works today, manually>","after":"<short phrase: how it works with AI>","approach":"<2 plain-language sentences on how AI would actually do it>","hoursPerWeek":<integer best-estimate hours saved per week>,"dollarsPerMonth":<integer rough monthly dollar value of that time, assuming ~$40/hr loaded cost>,"difficulty":"<Low|Medium|High>","firstStep":"<one concrete first step we'd take together>"}
Task: "${task}"`;
